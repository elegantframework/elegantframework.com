...
import card from './elegant-version-2.1.png';

export const meta = {
  title: 'Development Update - May 2023: Elegant version 2.1.',
  description: `Elegant framework version 2.1 is now available, with Next.js and more!`,
...
ConvertKit makes it easy to grow your email subscribers lists, sell more products and send targeted email newsletters – all by easily embedding email marketing / email subscriber forms anywhere within your Elegant application.

Find the full ConvertKit configuration guide here: [ConvertKit](/docs/convertkit).

## Google Analytics

We assume that most creators are going to want to track their metrics and growth, so we added the first of many analytics service providers integrations to come.
