...
Shoutout to [@Shiv-2712](https://github.com/Shiv-2712) and [@Armaan-Singh-Dhillon](https://github.com/Armaan-Singh-Dhillon) for their code contributions to the Elegant project.
...
Documentation is a never ending project, and is the motivating factor behind us starting this project. We have continued to make improvements to the Elegant documenation based on user feedback and friction.

We have also taken this oppurtunity to pilot our early version prototype of our new CMS panel for writing content. Our CMS development efforts have been progressing along smoothely, and we can't wait to debut it to the world in an upcoming release.
