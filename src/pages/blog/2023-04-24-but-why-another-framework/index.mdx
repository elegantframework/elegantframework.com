...
import card from './../../../../public/images/but-why-another-framework.png'

export const meta = {
  title: 'But why another framework?',
  description: `A detailed explanation as to why the world needs another framework`,
...
<div className="my-8 shadow-xl">
  <img src={card.src} height="200" alt="But why another frontend framework? A detailed explanation of the Elegant framework" className="rounded-xl"/>
</div>
