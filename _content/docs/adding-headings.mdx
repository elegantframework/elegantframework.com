...
![null](/api/images/screenshot-2024-02-02-123213-kwOT.png)You can also convert any text in the content editor by selecting the block of text, and then hovering over the “**Formatting**“ option in the Text Styling dropdown menu.

![null](/api/images/screenshot-2024-02-02-125345-c5MT.png)
