...
Elegant version 2.2 is already in the works and under active development, so make sure to check back often for news on upcoming updates and features.<br>
