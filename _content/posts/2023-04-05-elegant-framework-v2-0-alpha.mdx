...
<div class="my-8 shadow-xl"><img class="rounded-xl" src="/images/v2_0_elegantframework_com.3e193a62-QzMj.png" alt=""></div>
...
- [**Next.JS:**](https://www.elegantframework.com/blog/2023-04-05-elegant-framework-v2-0-alpha#next_js) Server-side rendering, static website generation, and much more.

- [**MDX Loader:**](https://www.elegantframework.com/blog/2023-04-05-elegant-framework-v2-0-alpha#mdx_loader) Build all of your content in an easy Markdown format.

- [**Tailwind CSS:**](https://www.elegantframework.com/blog/2023-04-05-elegant-framework-v2-0-alpha#tailwind_css) Beautifully designed, expertly crafted CSS styling.

- [**Jest Unit Testing:**](https://www.elegantframework.com/blog/2023-04-05-elegant-framework-v2-0-alpha#jest) Ensure your JavaScript code runs flawlessly every time.

- [**GitHub CI integrations:**](https://www.elegantframework.com/blog/2023-04-05-elegant-framework-v2-0-alpha#github_ci) Automate your deployment from inside your project.

- [**Elegant Starter Theme:**](https://www.elegantframework.com/blog/2023-04-05-elegant-framework-v2-0-alpha#elegant_seo_compared_wordpress_com) An amazing starter theme, with a near-perfect Lighthouse SEO Score.
...
```diff-javascript button.test.tsx
...
<div class="my-8 shadow-xl"><img class="rounded-xl" src="/images/elegant_seo_compared_wordpress_com.6d3f1e41-UxOD.png" alt=""></div>

The whole hypothesis behind this experiment was that the framework could be used to build all products and features of itself. A near-perfect SEO score at [**Elegant framework**](https://elegantframework.com/) translates into a near-perfect SEO score for Elegant users.
